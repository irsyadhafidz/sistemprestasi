...
Public Class ReportPrestasi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApp1.ReportPrestasi.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_nama_siswa() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReportPrestasi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportPrestasi = New ReportPrestasi()
        rpt.Site = Me.Site
        Return rpt
    End Function
